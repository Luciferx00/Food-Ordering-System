            ...
            <nav class="navbar-color"  style = "background-color : #ff6f47;">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light" style = "font-size:28px;"><?php echo "Rs.".$balance;?></a>
                        </li>
                    </ul>					
                </div>
            </nav>
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            <div class="row">
			  ...
			  <div>
			  <div class="input-field col s12">
                              <button class="btn right" type="submit"  style="  background: #ff6f47;" name="action">Order
