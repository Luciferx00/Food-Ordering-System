...
<table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn right" type="submit"  style="  background: #ff6f47;" name="action">Modify
...
<table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn right" type="submit"  style="  background: #ff6f47;" name="action">Add
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
