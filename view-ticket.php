...
<body>
  ...
  <header id="header" class="page-topbar">
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color"  style = "background-color : #ff6f47;">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="https://image.flaticon.com/icons/png/512/45/45200.png" alt="logo" style="height:50px; width:65px;" ></a> <span class="logo-text">Logo</span></h1></li>                     
                    <h1>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCuisine Culture</h1>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light" style = "font-size:28px;"><?php echo "Rs.".$balance;?></a></li>
                        </li>
                    </ul>					
                </div>
            </nav>
...
<div class="section">
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<button style="  background: #ff6f47;" class="waves-effect waves-light deep-orange btn white-text" type="submit" name="action">'
                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/ticket-message.php" novalidate="novalidate" class="col s12">					  
					  ...
					  <input type="hidden" name="ticket_id" value="'.$ticket_id.'">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn right" type="submit"  style="  background: #ff6f47;" name="action">Reply
  ...
  <!-- START FOOTER -->
  <footer class="page-footer"  style = "background-color : #ff6f47;">
